                      ...
                      items: [
                        if (appStore.isLoggedIn &&
                          ...
                          SettingItemWidget(
                            ...
                            trailing: Text(
                              '${isCurrencyPositionLeft ? appConfigurationStore.currencySymbol : ''}${appStore.userWalletAmount.toStringAsFixed(appConfigurationStore.priceDecimalPoint)}${isCurrencyPositionRight ? appConfigurationStore.currencySymbol : ''}',
